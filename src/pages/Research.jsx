          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="mb-4">
                ...
                elections are often manipulated to ensure the regime’s
                continuous grip on power. There are many different ways in which
                authoritarian regimes can manipulate electoral contests, ranging
                from ballot box stuffing to banning of opposition parties, but I
                am particularly interested in understanding how and why formally
              ...
              <p className="mb-4">
                ...
                authoritarian regimes fail to deliver change in power. Delving
                deep into the roles, responsibilities, powers, and
                organisational structures of election commissions and their
                relationships with different electoral stakeholders, I show how
                formally independent election commission can become
                authoritarian gatekeepers, hindering prospects for democracy in
                some contexts.
              </p>
              ...
              <p className="mb-4">
                ...
                scholarship in the disciplines of comparative politics,
                international relations and critical geopolitics. Nation
                branding is a popular practice among authoritarian regimes but
              ...
              <p className="mb-4">
                ...
                nation branding as an externally oriented, business-derived
                practice and instead understand it as an inherently
                inward-looking promotional strategy aimed at shaping the social
                attitudes and behaviours of the nation’s citizens in line with
              ...
              <p className="mb-4">
                ...
                By examining the different characteristics of Southeast Asian
                authoritarianism, we can gain a better understanding of the
              ...
              <p className="mb-4">
                ...
                findings will have important implications for our understanding
                of how China’s rise affects popular attitude towards democracy
                in Southeast Asia whilst demonstrating the need to understand
                the effects of the US-China rivalry beyond focusing on the level
              ...
              <p className="mb-6">
                ...
                of how authoritarian power is sustained and reproduced, I hope
                to inform efforts on how to promote democracy around the world
                in more effective and culturally and context-sensitive ways.
              </p>
            </div>
          </div>
        </div>
